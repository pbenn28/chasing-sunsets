---
title: Research and Oversight of AI in Courts Act of 2026
short_name: Research and Oversight of AI in Courts Act
bill_numbers:
- H.R. 7997
- S. 4154
congress: 119
...
scoring:
  ...
  rationale:
    ...
    B: "Silent on state authority; the only reference to state law is a definitional one (courts include 'all State and Federal courts') used to scope what the task force studies, not to regulate anyone."
    C: "Creates a 15-member task force with an 18-month deadline to report on AI transcription tools in the courts and recommend policy."
    D: "No export-control or geopolitical-competition provisions."
    E_consumer: "Focused on transcription accuracy in courtrooms, not deepfakes, NCII, companion bots, discrimination, or election integrity."
    F: "No data-center, permitting, or energy provisions."
    R: "A federal bill aimed squarely at how the federal judiciary uses AI transcription — a narrow slice of the AI landscape, but the task force's mandate covers that slice fully."
