...
scoring:
  ...
  rationale:
    A: "Gives the FTC clear enforcement authority over AI-generated impersonation fraud, but the obligation runs against fraudulent conduct generally rather than imposing requirements on frontier developers specifically. No compute or energy provisions in the bill."
    ...
    C: "Grants the FTC clear enforcement authority to act on AI-impersonation fraud, sharpening an existing regulator's toolkit rather than creating a new one."
