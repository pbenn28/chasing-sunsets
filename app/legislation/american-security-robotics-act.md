...
scoring:
  ...
  rationale:
    ...
    Depth: "Modest — the only axis moving off neutral by more than a point is D (geopolitical access restriction); A stays near the procurement floor and B, C, F are flat."
