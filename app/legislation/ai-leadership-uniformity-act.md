...
short_name: "AI Leadership and Uniformity Act"
bill_numbers: ["H.R. 5388"]
congress: 119
topic: "Preemption & Deregulation"
status: "committee"
chamber_origin: "House"
introduced_date: "2025-09-16"
last_action: "Referred to the House Committee on Science, Space, and Technology"
last_action_date: "2025-09-16"
sponsors: ["Rep. Michael Baumgartner (R-WA)"]
cosponsor_count: 0
...
scoring:
  ...
  rationale:
    A: "No obligation lands on AI developers anywhere in the bill. It directs the President to produce an annually-updated National AI Action Plan — a strategy document — while the substantive action is all on the preemption side."
    B: "Imposes a 5-year (not permanent) moratorium on states and localities enforcing laws that limit, restrict, or otherwise regulate AI models, systems, or automated decision systems in interstate commerce. It carves out laws that facilitate AI deployment, generally-applicable non-AI-specific requirements, criminal statutes, and state procurement — but doesn't touch state tort or common-law claims generally, only AI-specific civil-liability regimes."
    C: "The National AI Action Plan is aimed at removing regulatory barriers and promoting innovation, not at building oversight or enforcement capacity — no new agency, evaluation body, or incident database results from it."
    D: "No export-control, chip-access, or geopolitical-competition content."
    E_consumer: "No deepfake, NCII, companion-bot, discrimination, or election-integrity provisions — the bill is entirely about federal-state preemption."
    F: "No data-center, permitting, interconnection, or ratepayer content."
    R: "Targets the broad universe of state AI statutes restricting models or systems in interstate commerce; the carve-outs for procurement, criminal law, and deployment-facilitating laws are narrow next to that broad target."
