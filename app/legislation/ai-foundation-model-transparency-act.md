...
short_name: "AI Foundation Model Transparency Act"
bill_numbers: ["H.R. 8094"]
congress: 119
topic: "Transparency & Copyright"
status: "committee"
chamber_origin: "House"
introduced_date: "2026-03-26"
...
scoring:
  ...
  rationale:
    ...
    C: "Directs FTC rulemaking coordinated with NIST, Commerce, and the White House science office, plus a public-facing disclosure webpage — a real ongoing program, though short of a dedicated evaluation body or incident database."
    D: "No export-control or geopolitical content."
    E_consumer: "Targets foundation-model developer disclosure, not deepfakes, NCII, companion bots, discrimination, or election integrity."
    F: "No data-center, permitting, or energy content."
    R: "Covers foundation-model developers broadly, with no revenue or compute carve-outs narrowing who's covered."
